...
// _FUNCTION_H が /usr/include/c++/4.1.3/bits/stl_function.h と
// /usr/include/c++/4.1.3/backward/function.h で衝突してる！！
#ifndef _FUNCTION_H_
#define _FUNCTION_H_
// #ifndef _FUNCTION_H
// #  define _FUNCTION_H
...
/// stream output
extern tostream &   operator<<(tostream& i_ost, const std::list<tstringq> & i_data);
