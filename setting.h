...
public:
    Setting() : m_correctKanaLockHandling(false) , m_oneShotRepeatableDelay(0) { }
};
...
private:
    ...
    Modifier            m_defaultAssignModifier;                                    ///< default &lt;ASSIGN_MODIFIER&gt;
    Modifier            m_defaultKeySeqModifier;                                    ///< default &lt;KEYSEQ_MODIFIER&gt;
...
private:
    ...
    void        load_IF();                                                          ///< &lt;IF&gt;
    void        load_ELSE(bool i_isElseIf, const tstringi &i_token);                ///< &lt;ELSE&gt; &lt;ELSEIF&gt;
    ...
    Modifier    load_MODIFIER(Modifier::Type i_mode, Modifier i_modifier, Modifier::Type *o_mode = NULL);   ///< &lt;..._MODIFIER&gt;
    Key *       load_KEY_NAME();                                                    ///< &lt;KEY_NAME&gt;
    void        load_KEYMAP_DEFINITION(const Token *i_which);                       ///< &lt;KEYMAP_DEFINITION&gt;
    ...
    KeySeq *    load_KEY_SEQUENCE(const tstringi &i_name = _T(""), bool i_isInParen = false,
    ...
    /// get filename
    bool        getFilename(const tstringi &i_name, tstringi *o_path, int i_debugLevel = 1) const;
